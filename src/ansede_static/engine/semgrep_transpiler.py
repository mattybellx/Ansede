...
"""},
    ...
    "PY-022": {
        ...
        "patterns": [
            ...
            {"pattern-not-regex": "os\\.path\\.join\\([^,]+,\\s*[\"']"},
        ],
...
"""},
    ...
    "JS-011": {
        ...
        "patterns": [
            ...
            {"pattern-regex": "(?i)(password|secret|api[_-]?key|token)\\s*=\\s*['\\\"][^'\\\"]{8,}"},
        ],
...
"""},
    ...
    "JS-043": {
        ...
        "patterns": [
            ...
            {"pattern-not-regex": "resolveExternalEntities:\\s*false|noent|noentities"},
        ],
    ...
    "JS-045": {
        ...
        "patterns": [
            ...
            {"pattern-not-regex": "secure:\\s*true"},
        ],
