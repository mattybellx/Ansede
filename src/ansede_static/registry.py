"""Community rule registry management for ansede-static."""
...
from ansede_static.config import _normalized_rule_token, load_config
from ansede_static.yaml_rules import (
    CustomRule,
...
def _build_registry_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="ansede-static registry")
...
def handle_registry_command(
    ...
    *,
    ...
    """Entry point for ``ansede-static registry``."""
    ...
    if args.fetch:
        try:
            ...
            print(f"ansede-static: registry error: {exc}")
            return 2
