...
>
> **Current Baseline:** v2.3.2 · Rust fast-path · 98.8% CVE recall · 96.4% precision · 7 languages · 35 real-world repos validated
> **Target:** v3.0 · Source-map resolution bridging web-wild gap · Symbolic guard precision · Enterprise-grade repo structure
>
> **Overall Progress: ~88% strict / ~92% weighted** — v3.0 nearing completion
>
> **Repo restructured (2026-05-28):** `BENCHMARKS.md`, `CITATION.cff` → `docs/`; `NodeGoat/`, `internet_code_samples/` → `samples/`; `gradle-8.7/` → `intellij-plugin/`; `AS.png` + banners → `assets/`; `final_scorecard.json` → `reports/`
